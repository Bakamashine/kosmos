...
return [
    ...
    */
    ...
    'accepted' => 'Поле :attribute должно быть обязательным.',
    'accepted_if' => 'Поле :attribute должно быть обязательным, когда :other равно :value.',
    ...
    'mimes' => 'Файл в поле :attribute должен быть одним из следующих типов: :values.',
    'mimetypes' => 'Файл в поле :attribute должен быть одним из следующих типов: :values.',
    'min' => [
    ...
    'password' => [
        ...
        'mixed' => 'Поле :attribute должно содержать как строчные, так и прописные буквы.',
        'numbers' => 'Поле :attribute должно содержать хотя бы одну цифру.',
        'symbols' => 'Поле :attribute должно содержать хотя бы один символ.',
        'uncompromised' => 'Указанный :attribute был найден в базе утечек данных. Пожалуйста, выберите другой.',
    ],
    ...
    'prohibited_if_accepted' => 'Поле :attribute запрещено, когда :other обязательным.',
    ...
    'required_if_accepted' => 'Поле :attribute обязательно, когда :other обязательным.',
    ...
    */
    ...
    'custom' => [
        'order_id' => [
            'unique' => 'Вы не можете оставить отзыв повторно',
            'required' => 'Вы должны выбрать свой заказ'
        ],
        "vacancy_id" => [
            "unique" => "Вы не можете выбрать два раза одну и ту же вакансию",
        ],
        "flying_id" => [
            "required" => "Вы должны выбрать полёт"
        ],
        "date" => [
            "unique" => "Вы не можете выбрать дату, на которую уже делали выбор",
            "after_or_equal" => "Вы можете выбрать только сегодняшнюю дату или позднее"
        ]
    ],
