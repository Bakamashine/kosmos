        ...
        <Layout>
            ...
            <div>
                ...
                <p>
                    ...
                    сайт создан для тех, кто хочет узнать о звёздах, планетах и
                    космических явлениях без сложных формул и академического
                    жаргона.
                </p>
                <h4>Наша миссия</h4>
                <p>
                ...
                <p>
                    ...
                    Сегодня "Недалёкий космос" — это статьи, новости,
                    интерактивные карты и сообщество, где каждый может задать
                    вопрос или поделиться открытием.
                </p>
                <h4>Наша команда</h4>
                <ul>
                    <li>
                    ...
                    <li>
                        <strong>Мария Петрова</strong> — журналист и популяризатор науки. Пишет
                        статьи, которые объясняют сложное просто.
                    </li>
                    <li>
                        <strong>Дмитрий Сидоров</strong> — разработчик. Создаёт интерактивные
                        инструменты и приложения для наблюдений.
                    </li>
                    <li>
                        <strong>Анна Кузнецова</strong> — иллюстратор и дизайнер. Рисует звёздные
                        карты и визуализации. Мы — не корпорация, а сообщество
                        единомышленников.
                    </li>
                </ul>
                <p>
                    ...
                    Напишите на email: info@nedalyokiy-kosmos.ru или
